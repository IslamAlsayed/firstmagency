...
<head>
    ...
    <style>
        ...
        header {
            background: radial-gradient(ellipse at bottom, var(--dark-color) 0%, hsl(var(--hue), 20%, 13%) 100%);
            ...
            <section class="info">
                <ul>
                    ...
                    <li>
                        ...
                        <span>You are seeing this page because the homepage URL is not configured and <a target="_blank" href="https://symfony.com/doc/<?php echo $docVersion; ?>/debug-mode">debug
                                mode</a> is enabled.</span>
                    </li>
                </ul>
