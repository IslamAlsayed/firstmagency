...
class AuthTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTokenRequestWithAuthUrlParams()
    {
        ...
        $this->assertEquals(
            $overriddenAuthParams['authHeaders'],
            $ably->http->headers,
    ...
    public function testAuthorize()
    {
        ...
        $ably->auth->authorize();
        $this->assertFalse(
            $tokenOriginal->token == $ably->auth->getTokenDetails()->token,
    ...
    public function testAuthorizeParams()
    {
        ...
        $this->assertFalse(
            isset($ably->auth->getSavedAuthorizeTokenParams()['timestamp']),
            'Expected authorize() to save provided tokenParams without the `timestamp` field'
        );
        $this->assertFalse(
            isset($ably->auth->getSavedAuthorizeAuthOptions()['force']),
    ...
    public function testAuthorizeRememberDefaults()
    {
        ...
        $this->assertLessThan(
            Miscellaneous::systemTime() + 20000,
            $token2->expires,
