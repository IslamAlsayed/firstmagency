...
@section('page-title', '⚡ ' . __('dashboard.settings'))
    ...
    <div class="background rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-5 border-custom-b-1">
            <h5 class="text-2xl font-semibold text-blue-900">
                ...
                {{ __('dashboard.settings_management') }}
            </h5>
        </div>
        <div class="p-4">
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <form action="{{ route('dashboard.settings.updateGeneral') }}" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mb-4">
                            <div>
                                <label for="site-email" class="block text-sm font-semibold text-gray-600 mb-1">{{ __('dashboard.site_email') }}</label>
                                <input type="email" id="site-email" name="site_email"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent background text-gray-600 font-medium shadow-sm"
                                    placeholder="email@example.com" value="{{ $settings->site_email ?? 'info@firstmagency.com' }}">
                            </div>
                            <div>
                                <label for="site-whatsapp" class="block text-sm font-semibold text-gray-600 mb-1">{{ __('dashboard.site_whatsapp') }}</label>
                                <input type="tel" id="site-whatsapp" name="site_whatsapp"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent background text-gray-600 font-medium shadow-sm"
                                    placeholder="WhatsApp Number" value="{{ $settings->site_whatsapp ?? '201212601601' }}">
                            </div>
                            <div>
                                <label for="site-phone" class="block text-sm font-semibold text-gray-600 mb-1">{{ __('dashboard.site_phone') }}</label>
                        ...
                        <div>
                            <label for="site-locale" class="block text-sm font-semibold text-gray-600 mb-1">{{ __('dashboard.site_locale') }}</label>
                    ...
                    <form action="{{ route('dashboard.settings.updateColorsWebsite') }}" method="POST" class="space-y-5">
                        ...
                        <div class="flex items-center flex-wrap gap-4">
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="main-color" class="block text-sm font-semibold text-gray-600 mb-1">Main Color</label>
                            ...
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="dark-main-color" class="block text-sm font-semibold text-gray-600 mb-1">Dark Main Color</label>
                                <input type="color" id="dark-main-color" name="dark_main_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->dark_main_color ?? '#96310E' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="light-main-color" class="block text-sm font-semibold text-gray-600 mb-1">Light Main Color</label>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <form action="{{ route('dashboard.settings.updateColors') }}" method="POST" class="space-y-5">
                        ...
                        <div class="flex items-center flex-wrap gap-4">
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="primary-color" class="block text-sm font-semibold text-gray-600 mb-1">Primary Color</label>
                                <input type="color" id="primary-color" name="primary_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->primary_color ?? '#6f42c1' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="secondary-color" class="block text-sm font-semibold text-gray-600 mb-1">Secondary Color</label>
                                <input type="color" id="secondary-color" name="secondary_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->secondary_color ?? '#6c757d' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="success-color" class="block text-sm font-semibold text-gray-600 mb-1">Success Color</label>
                                <input type="color" id="success-color" name="success_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->success_color ?? '#198754' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="danger-color" class="block text-sm font-semibold text-gray-600 mb-1">Danger Color</label>
                                <input type="color" id="danger-color" name="danger_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->danger_color ?? '#dc3545' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="warning-color" class="block text-sm font-semibold text-gray-600 mb-1">Warning Color</label>
                                <input type="color" id="warning-color" name="warning_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->warning_color ?? '#ffc107' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="info-color" class="block text-sm font-semibold text-gray-600 mb-1">Info Color</label>
                                <input type="color" id="info-color" name="info_color"
                                    class="w-full h-12 rounded-lg cursor-pointer border-2 border-gray-300 shadow-sm"
                                    value="{{ $settings->info_color ?? '#0dcaf0' }}">
                            </div>
                            <div class="flex-1 text-nowrap" style="min-width: 100px;">
                                <label for="accent-color" class="block text-sm font-semibold text-gray-600 mb-1">Accent Color</label>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <form action="{{ route('dashboard.settings.updateFonts') }}" method="POST" class="space-y-5">
                        ...
                        @method('PUT')
                        <div>
                            <label for="font-url" class="block text-sm font-semibold text-gray-600 mb-1">Font URL</label>
                        ...
                        <div>
                            <label for="font-name" class="block text-sm font-semibold text-gray-600 mb-1">Font Name</label>
                    ...
                    <form action="{{ route('dashboard.settings.updateInlinePadding') }}" method="POST" class="space-y-5">
                        ...
                        <div class="kt-card mb-4">
                            <div class="kt-card-header">
                                <h3 class="kt-card-title">Home Page</h3>
                            </div>
