    ...
    <div class="w-full">
        ...
        <div class="flex flex-wrap gap-4 mb-6">
            <div class="flex-1 text-center p-4 bg-gray-50 rounded-lg border border-gray-200 z--1">
                <div class="text-2xl font-bold text-gray-800" id="stat-total">{{ count($programmings) }}</div>
                <small class="text-primary font-semibold text-nowrap">{{ __('main.total_programmings') }}</small>
            </div>
            <div class="flex-1 text-center p-4 bg-gray-50 rounded-lg border border-gray-200 z--1">
                <div class="text-2xl font-bold text-green-600" id="stat-active">{{ $programmings->where('is_active', true)->count() }}</div>
                <small class="text-primary font-semibold text-nowrap">{{ __('main.active') }}</small>
            </div>
            <div class="flex-1 text-center p-4 bg-gray-50 rounded-lg border border-gray-200 z--1">
                <div class="text-2xl font-bold text-red-600" id="stat-inactive">{{ $programmings->where('is_active', false)->count() }}</div>
                    ...
                    <tbody>
                        @forelse($programmings as $programming)
                            <tr id="row-{{ $programming->id }}" class="border-b border-gray-200 hover:bg-gray-50 transition"
                                data-active="{{ (int) $programming->is_active }}">
