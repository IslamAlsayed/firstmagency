    ...
    <div class="shadow-md radius-lg p-6">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                @can('update', $project)
                    <a href="{{ route('dashboard.projects.edit', $project->id) }}" class="kt-btn kt-btn-primary md:hidden" toggle-button>
                        <i class="ki-filled ki-pencil text-sm me-2"></i>
                        {{ __('main.edit') }}
                    </a>
                @endcan
                <a href="{{ route('dashboard.projects.index') }}" class="kt-btn kt-btn-outline" toggle-button>
