                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_en" value="{{ old('title_en', $marketingPackage->translations['en']['title']) }}"
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_ar" required value="{{ old('title_ar', $marketingPackage->translations['ar']['title']) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="order" name="order" min="0"
                                ...
                                value="{{ old('order', $marketingPackage->order) }}" placeholder="0">
                            @error('order')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
