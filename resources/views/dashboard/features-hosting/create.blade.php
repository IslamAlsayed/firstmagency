...
@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.create_type', ['type' => __('main.features_hosting')]) }}</h3>
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.features-hosting.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-6">
                    ...
                    <!-- Save Button -->
                    @include('dashboard.components.save-submit', ['models' => 'dashboard.features-hosting', 'model' => 'features-hosting'])
                </div>
            </form>
        </div>
    </div>
