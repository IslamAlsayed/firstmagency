...
@section('content')
    <div class="kt-card mb-4">
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.features-hosting.update', $hostingFeature->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title_en" name="title_en"
                                    value="{{ old('title_en', $hostingFeature->translations['en']['title'] ?? '') }}"
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title_ar" name="title_ar"
                                    value="{{ old('title_ar', $hostingFeature->translations['ar']['title'] ?? '') }}"
