...
@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            ...
            <a href="{{ route('dashboard.features-hosting.index') }}" class="kt-btn kt-btn-outline-primary">
                {{ __('main.back_to_types', ['types' => __('main.features_hostings')]) }}
            </a>
        </div>

        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.features-hosting.update', $featuresHosting->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid gap-6">
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title_en" name="title_en"
                                    value="{{ old('title_en', $featuresHosting->translations['en']['title'] ?? '') }}"
                            ...
                            @include('dashboard.components.input-text-editor', [
                                'name' => 'description_en',
                                'value' => old('description_en', $featuresHosting->translations['en']['description'] ?? ''),
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title_ar" name="title_ar"
                                    value="{{ old('title_ar', $featuresHosting->translations['ar']['title'] ?? '') }}"
                            ...
                            @include('dashboard.components.input-text-editor', [
                                'name' => 'description_ar',
                                'value' => old('description_ar', $featuresHosting->translations['ar']['description'] ?? ''),
                    ...
                    <!-- Image Upload -->
                    @include('dashboard.components.photo', ['column' => 'image', 'record' => $featuresHosting])
                    ...
                    <!-- Update Button -->
                    @include('dashboard.components.update-submit', ['models' => 'dashboard.features-hosting', 'model' => 'features-hosting'])
                </div>
            </form>
        </div>
    </div>
