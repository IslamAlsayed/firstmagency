...
@section('title', __('main.create_partner'))
@section('page-title', '🤝 ' . __('main.create_partner'))

@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.create_partner') }}</h3>
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.partners.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-4">
                    ...
                    <!-- Save Button -->
                    @include('dashboard.components.save-submit', ['models' => 'dashboard.partners', 'model' => 'partner'])
                </div>
            </form>
        </div>
    </div>
