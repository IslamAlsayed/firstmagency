...
@section('title', __('main.edit_type', ['type' => __('main.faq')]))
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1" id="question"
                                    name="question" value="{{ old('question', $faq->question) }}" placeholder="Enter question in English">
                                @error('question')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1" id="question_ar"
                                    name="question_ar" value="{{ old('question_ar', $faq->question_ar) }}" placeholder="أدخل السؤال بالعربية">
                                @error('question_ar')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
