                ...
                <table class="w-full border-collapse">
                    <thead>
                        <tr class="bg-gray-100 border-b-2 border-gray-300">
                            ...
                            <th class="p-4 text-left text-sm font-semibold text-gray-700">{{ __('main.country') }}</th>
                            <th class="p-4 text-left text-sm font-semibold text-gray-700">{{ __('main.rating') }}</th>
                            <th class="p-4 text-left text-sm font-semibold text-gray-700">{{ __('main.message') }}</th>
                    ...
                    <tbody>
                        @forelse($reviews as $review)
                            <tr id="row-{{ $review->id }}" class="border-b border-gray-200 hover:bg-gray-50 transition" data-status="{{ $review->status }}">
                                ...
                                <td class="p-4 text-gray-600 text-sm" title="{{ $review->comment }}">
