...
@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.edit_line_work') }}</h3>

            <a href="{{ route('dashboard.line-works.index') }}" class="kt-btn kt-btn-outline-primary">
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_en" required value="{{ old('title_en', $lineWork->translations['en']['title'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description_en" name="description_en" rows="5" placeholder="Enter description in English">{{ old('description_en', $lineWork->translations['en']['description'] ?? '') }}</textarea>
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_ar" required value="{{ old('title_ar', $lineWork->translations['ar']['title'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description_ar" name="description_ar" rows="5" placeholder="أدخل الوصف بالعربية">{{ old('description_ar', $lineWork->translations['ar']['description'] ?? '') }}</textarea>
