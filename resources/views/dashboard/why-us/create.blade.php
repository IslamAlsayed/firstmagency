...
@section('title', __('main.create_type', ['type' => __('main.why_us')]))
@section('page-title', '🌟 ' . __('main.create_type', ['type' => __('main.why_us')]))

@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.create_type', ['type' => __('main.why_us')]) }}</h3>
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.why-us.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-4">
                    ...
                    <!-- Save Button -->
                    @include('dashboard.components.save-submit', ['models' => 'dashboard.why-us', 'model' => 'why_us'])
                </div>
            </form>
        </div>
    </div>
