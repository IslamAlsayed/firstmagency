                ...
                <div class="grid gap-4 lg:gap-6">
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="name_en" value="{{ old('name_en', $pestDomain->translations['en']['name'] ?? '') }}" placeholder="Enter name in English">
                                @error('name_en')
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description_en" name="description_en" rows="5" placeholder="Enter description in English">{{ old('description_en', $pestDomain->translations['en']['description'] ?? '') }}</textarea>
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="name_ar" required value="{{ old('name_ar', $pestDomain->translations['ar']['name'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description_ar" name="description_ar" rows="5" placeholder="أدخل الوصف بالعربية">{{ old('description_ar', $pestDomain->translations['ar']['description'] ?? '') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="website" value="{{ old('website', $pestDomain->website) }}"
