...
@section('title', __('main.create_type', ['type' => __('main.pest_domain')]))
...
@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.create_type', ['type' => __('main.pest_domain')]) }}</h3>

            <a href="{{ route('dashboard.pest-domains.index') }}" class="kt-btn kt-btn-outline-primary" style="color: var(--text_color); background-color: var(--button_color);" toggle-button>
                ...
                <div class="grid gap-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="old_price" value="{{ old('old_price', 0) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50" placeholder="0.00"
                                step="0.01" min="0" readonly id="old_price">
                    ...
                    <!-- Save Button -->
                    @include('dashboard.components.save-submit', ['models' => 'dashboard.pest-domains', 'model' => 'pest_domain'])
                </div>
            </form>
        </div>
    </div>
