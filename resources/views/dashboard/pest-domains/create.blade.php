            ...
            <div class="grid gap-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="old_price" value="{{ old('old_price', 0) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50" placeholder="0.00" step="0.01"
                            min="0" readonly id="old_price">
