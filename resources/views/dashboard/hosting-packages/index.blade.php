                    ...
                    <table class="w-full border-collapse" id="packagesTable">
                        <thead>
                            <tr class="bg-gray-100 border-b-2 border-gray-300">
                                ...
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">{{ __('main.monthly_label') }}</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">{{ __('main.yearly_label') }}</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">{{ __('main.popular') }}</th>
