...
@section('title', __('main.create_type', ['type' => __('main.work_us_step')]))
@section('page-title', '👔 ' . __('main.create_type', ['type' => __('main.work_us_step')]))

@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.create_type', ['type' => __('main.work_us_step')]) }}</h3>
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.work-us-step.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4">
                    ...
                    <!-- Save Button -->
                    @include('dashboard.components.save-submit', ['models' => 'dashboard.work-us-step', 'model' => 'work_us_step'])
                </div>
            </form>
        </div>
    </div>
