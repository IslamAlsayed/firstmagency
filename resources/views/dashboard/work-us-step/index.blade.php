    ...
    <div class="w-full">
        ...
        <div class="flex flex-wrap gap-4 mb-6">
            <div class="flex-1 text-center p-4 bg-gray-50 rounded-lg border border-gray-200 z--1">
                <div class="text-2xl font-bold text-gray-800" id="stat-total">{{ $workUsSteps->total() }}</div>
                <small class="text-primary font-semibold text-nowrap">{{ __('main.total_work_us_step') }}</small>
            </div>
            <div class="flex-1 text-center p-4 bg-gray-50 rounded-lg border border-gray-200 z--1">
                <div class="text-2xl font-bold text-green-600" id="stat-active">{{ $workUsSteps->where('is_active', true)->count() }}</div>
