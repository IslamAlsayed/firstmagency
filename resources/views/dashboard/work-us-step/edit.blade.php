...
@section('title', __('main.edit_type', ['type' => __('main.work_us_step')]))
@section('page-title', '👔 ' . __('main.edit_type', ['type' => __('main.work_us_step')]))

@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.edit_type', ['type' => __('main.work_us_step')]) }}</h3>
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.work-us-step.update', $workUsStep->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid gap-4">
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_en" value="{{ old('title_en', $workUsStep->translations['en']['title'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description_en" name="description_en" rows="5" placeholder="Enter description in English">{{ old('description_en', $workUsStep->translations['en']['description'] ?? '') }}</textarea>
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_ar" value="{{ old('title_ar', $workUsStep->translations['ar']['title'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description_ar" name="description_ar" rows="5" placeholder="أدخل الوصف بالعربية">{{ old('description_ar', $workUsStep->translations['ar']['description'] ?? '') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        @include('dashboard.components.photo', ['column' => 'image', 'model' => $workUsStep, 'folder' => 'work-us-step'])
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="alt_text" value="{{ old('alt_text', $workUsStep->alt_text) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="order" value="{{ old('order', $workUsStep->order) }}"
                    ...
                    <div class="flex flex-wrap" style="gap: 10px 40px;">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            @include('dashboard.components.checkbox-button', [
                                ...
                                'id' => 'is_featured',
                                'value' => '1',
                                'checked' => $workUsStep->is_featured,
