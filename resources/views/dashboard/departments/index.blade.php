        ...
        <div class="bg-white rounded-lg shadow">
            <div class="flex justify-between items-center p-4 border-gray-200">
                ...
                <div class="flex justify-between items-center gap-4">
                    ...
                    <a href="{{ route('dashboard.departments.create') }}" class="kt-btn kt-btn-outline-primary">
                    ...
                    <table class="w-full border-collapse">
                        <thead>
                            <tr class="bg-gray-100 border-b-2 border-gray-300">
                                ...
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">{{ __('main.name') }}(عربي)</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">{{ __('main.username') }}</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">{{ __('main.styling') }}</th>
