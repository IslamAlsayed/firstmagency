...
@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.create_type', ['type' => __('main.department')]) }}</h3>

            <a href="{{ route('dashboard.departments.index') }}" class="kt-btn kt-btn-outline-primary" style="color: var(--text_color); background-color: var(--button_color);" toggle-button>
            ...
            <form method="POST" action="{{ route('dashboard.departments.store') ?? '#' }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 lg:gap-6">
                    ...
                    <div class="lg:col-span-1">
                        <div class="kt-card sticky top-20">
