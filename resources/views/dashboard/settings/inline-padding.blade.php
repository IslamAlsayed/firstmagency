                    ...
                    <div class="w-full flex items-center justify-between gap-4 inline-padding-search-wrapper">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <input type="text" id="inline-padding-search" placeholder="{{ __('main.search_types_placeholder', ['types' => __('main.sections')]) }}"
                                class="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500 focus:border-transparent background text-gray-600 font-medium shadow-sm">
                        </div>
                    </div>
                </h6>
                ...
                <form action="{{ route('dashboard.settings.inline-padding.update') }}" method="POST" class="space-y-5" id="inline-padding-toggle-sections">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-lowercase" id="inline-padding-sections">
                        ...
                        <div class="inline-padding-section" data-section="flag-hero">
                            <label for="home-hero-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                                <span>flag-hero</span>
                        ...
                        <div class="inline-padding-section" data-section="flag-services">
                            <label for="home-services-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-projects">
                            <label for="home-projects-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-reviews">
                            <label for="home-reviews-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-clients">
                            <label for="home-clients-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-portfolio">
                            <label for="portfolio-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-articles">
                            <label for="blog-articles-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-articles-page">
                            <label for="articles-page-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-tickets">
                            <label for="tickets-page" class="flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-website-developer">
                            <label for="website-developer-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-programming">
                            <label for="website-programming-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-website-designer">
                            <label for="website-design-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-important-articles">
                            <label for="website-important-articles-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-faq">
                            <label for="faqs-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                                <span>flag-faq</span>
                                <span class="text-blue-600">(px)</span>
                            </label>
                        ...
                        <div class="inline-padding-section" data-section="flag-app-developer-hero">
                            <label for="app-developer-hero-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-order-app">
                            <label for="order-app-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-categories-programming">
                            <label for="categories-programming-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-projects-steps">
                            <label for="projects-steps-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-hosting-hero">
                            <label for="hosting-hero-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-hosting-features">
                            <label for="hosting-features-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-hosting-packages">
                            <label for="packages-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-support-hosting">
                            <label for="support-hosting-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-operating-systems">
                            <label for="operations-systems-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-your-domain">
                            <label for="your-domain-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-pest-domains">
                            <label for="pest-domains-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-official-domains">
                            <label for="official-domains-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-why-us">
                            <label for="why-us-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-marketing-hero">
                            <label for="marketing-hero-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-platform-management">
                            <label for="platform-management-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-work-lines">
                            <label for="work-lines-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-dont-worry-hosting">
                            <label for="dont-worry-hosting-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-easy-management">
                            <label for="easy-management-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                        ...
                        <div class="inline-padding-section" data-section="flag-packages-marketing">
                            <label for="packages-marketing-section" class="flag-text flex items-center justify-between gap-2 text-sm font-semibold text-primary mb-1">
                    ...
                    <button type="submit" toggle-button class="custom-btn flex items-center gap-2 px-4 py-2 cursor-pointer text-white bg-primary text-gray-600 font-semibold rounded-[9px] shadow-md">
