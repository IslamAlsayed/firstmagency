...
@section('content')
    <div class="kt-card mb-4">
        ...
        <div class="kt-card-body p-4">
            <form method="POST" action="{{ route('dashboard.features-hostings.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-6">
                    ...
                    <div class="flex gap-2 pt-4">
                        <button type="submit" class="kt-btn kt-btn-primary">
                            <i class="fas fa-save mr-2"></i>{{ __('main.save') }}
                        </button>
                        <button type="submit" name="save_and_add" value="1" class="kt-btn kt-btn-outline-primary">
                            <i class="fas fa-plus mr-2"></i>{{ __('main.save_and_add_another') }}
                        </button>
                    </div>
                </div>
            </form>
