...
@section('content')
    <div class="kt-card mb-4">
        <div class="kt-card-header flex items-center justify-between gap-4">
            <h3 class="kt-card-title">{{ __('main.edit_type', ['type' => __('main.hosting_feature')]) }}</h3>

            <a href="{{ route('dashboard.hosting-features.index') }}" class="kt-btn kt-btn-outline-primary">
