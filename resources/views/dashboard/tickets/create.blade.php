                ...
                <div class="grid gap-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label for="name" class="mb-2 block text-sm font-semibold text-gray-700">
                                {{ __('main.contact_form_name') }} <span class="text-red-500">*</span>
                            </label>
                        ...
                        <div>
                            <label for="email" class="mb-2 block text-sm font-semibold text-gray-700">
                                {{ __('main.contact_form_email') }} <span class="text-red-500">*</span>
                            </label>
                    ...
                    <div>
                        <label for="message" class="mb-2 block text-sm font-semibold text-gray-700">
                            {{ __('main.contact_form_message') }} <span class="text-red-500">*</span>
                        </label>
                        <textarea id="message" name="message" rows="5" required placeholder="{{ __('main.contact_form_message_placeholder') }}"
