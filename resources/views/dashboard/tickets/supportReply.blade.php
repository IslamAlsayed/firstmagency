                                    ...
                                    <div class="meta">
                                        ...
                                        <div class="flex gap-2">
                                            <span class="w-fit block text-xs px-2 py-1 rounded-full badge-message"
                                                ...
                                                {{ $message['sender_type'] == 'customer' ? __('main.customer') : (app()->getLocale() == 'ar' ? $message['department']['name_ar'] : $message['department']['name'] ?? __('main.support')) }}
                                            </span>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addAttachmentBtn?.addEventListener('click', function() {
                ...
                div.style =
                    'text-align: {{ app()->getLocale() == 'ar' ? 'end' : 'start' }} !important; border: 1px solid var(--color-gray-300); @error('attachments') border: 1px solid red !important @enderror';
