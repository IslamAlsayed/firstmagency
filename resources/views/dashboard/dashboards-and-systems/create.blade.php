                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_en" value="{{ old('title_en') }}" placeholder="Enter title in English" required>
                                @error('title_en')
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    name="title_ar" required value="{{ old('title_ar') }}" placeholder="أدخل العنوان بالعربية" required>
                                @error('title_ar')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
