...
@section('title', __('main.edit_type', ['type' => __('main.official_domain')]))
@section('page-title', '🌐 ' . __('main.edit_type', ['type' => __('main.official_domain')]))

@section('content')
    <div class="shadow-lg radius-lg p-4">
        <form method="POST" action="{{ route('dashboard.official-domains.update', $officialDomain) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid gap-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="order" value="{{ old('order', $officialDomain->order) }}"
                ...
                <div class="flex flex-wrap" style="gap: 10px 40px;">
                    <div class="flex items-center gap-3">
                        ...
                        @include('dashboard.components.checkbox-button', [
                            ...
                            'id' => 'is_active',
                            'value' => '1',
                            'checked' => old('is_active', $officialDomain->is_active),
                ...
                <!-- Update Button -->
                @include('dashboard.components.update-submit', ['models' => 'dashboard.official-domains', 'model' => 'official_domain'])
            </div>
        </form>
    </div>
@endsection
