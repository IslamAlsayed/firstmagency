            ...
            <div class="grid gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $programmingCategory->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="name_ar" name="name_ar" value="{{ old('name_ar', $programmingCategory->name_ar) }}"
                ...
                <!-- Update Button -->
                @include('dashboard.components.update-submit', ['models' => 'dashboard.programming-categories', 'model' => 'category'])
            </div>
        </form>
    </div>
@endsection
