...
@section('title', __('main.create_type', ['type' => __('main.project_step')]))
@section('page-title', '📋 ' . __('main.create_type', ['type' => __('main.project_step')]))

@section('content')
    <div class="shadow-lg radius-lg p-6">
        <form method="POST" action="{{ route('dashboard.project-steps.store') }}">
            @csrf
            <div class="grid gap-4">
                ...
                <div class="grid grid-cols-2 items-center gap-4">
                    <div>
                        <label for="icon" class="flex gap-6 text-sm font-semibold text-gray-700">
                            <div>
                                {{ __('main.icon') }} <span class="text-red-500">*</span>
                            </div>
                ...
                <!-- Save Button -->
                @include('dashboard.components.save-submit', ['models' => 'dashboard.project-steps', 'model' => 'project-step'])
            </div>
        </form>
    </div>
@endsection
