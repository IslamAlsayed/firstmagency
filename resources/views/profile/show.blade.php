...
@section('content')
    <div class="bg-gradient-to-br from-gray-50 to-gray-100 py-12">
        ...
        <div class="flex flex-col gap-6 profileEditApp">
            {{-- <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 profileEditApp"> --}}
            <!-- Sidebar - Profile Photo & Quick Actions -->
            <div class="col-span-2">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <!-- Profile Photo -->
                    <div class="col-span-2 bg-white radius-lg shadow-sm overflow-hidden p-6">
                        <!-- Avatar -->
                        <div class="flex flex-col items-center -mt-12 mb-4">
                            @if ($user->photo && checkExistFile($user->photo))
                                <img src="{{ asset('storage/' . $user->photo) }}" alt="{{ $user->name }}" class="w-24 h-24 rounded-full border-4 border-white shadow-sm object-cover">
                            @else
                                @if ($user->photo)
                                    <img src="{{ asset('assets/images/avatars/' . $user->photo) }}" alt="{{ $user->name }}" class="w-24 h-24 rounded-full border-4 border-white shadow-sm object-cover">
                                @else
                                    <div class="w-24 h-24 rounded-full border-4 border-white shadow-sm bg-gray-300 flex items-center justify-center">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('dashboard.profile.edit') }}"
                                class="w-full inline-block text-center px-4 py-2 bg-blue-600 text-white radius-lg hover:bg-blue-700 transition duration-200 font-medium">
                                <i class="fas fa-edit mx-2"></i>
                                {{ __('main.edit_profile') }}
                            </a>
                            <a href="{{ route('dashboard.profile.activity') }}"
                                class="w-full inline-block text-center px-4 py-2 bg-gray-200 text-gray-800 radius-lg hover:bg-gray-300 transition duration-200 font-medium">
                    ...
                    <!-- Account Switcher -->
                    <div class="col-span-1 bg-white radius-lg shadow-sm overflow-hidden p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                            {{-- <i class="fas fa-user text-indigo-600 mx-3"></i> --}}
                            <i class="ki-filled ki-arrow-right-left text-lg mx-3"></i>
                            {{ __('messages.switch_to_anther_user') }}
                        </h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="">
                    ...
                    <div class="bg-white radius-lg shadow-sm overflow-hidden p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Name -->
                            <div class="bg-gray-200 p-4 radius-lg">
                                <label class="text-sm font-medium text-gray-700">{{ __('main.name') }}</label>
                                <p class="text-gray-900 font-medium">{{ ucfirst($user->name ?? '--') }}</p>
                            </div>
                ...
                <div class="">
                    ...
                    <div class="bg-white radius-lg shadow-sm overflow-hidden p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-200 radius-lg">
                                <div>
