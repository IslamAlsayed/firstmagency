<div class="section packages-sections text-center">
    <div class="mb-8">
    ...
    <div class="">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {{-- هنا يتم استدعاء النوع المطلوب من الـ config --}}
                            ...
                            <div class="mb-6">
                                <div class="image">
                                    @if (isset($package['image']) && checkExistFileInPublic($package['image']))
                                        <img src="{{ asset('assets/images/' . $package['image']) }}" class="w-16 mx-auto mb-4" alt="{{ $package['name'] }}">
                                    @else
