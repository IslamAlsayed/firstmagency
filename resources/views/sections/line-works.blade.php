    ...
    <div class="steps">
                ...
                <div class="step">
                    ...
                    <div class="image">
                        @if ($lineWork->image && checkExistFile($lineWork->image))
                            <img src="{{ asset('storage/' . $lineWork->image) }}" alt="{{ $lineWork->translations[app()->getLocale()]['title'] }}" loading="lazy" class="clickable-img"
                                data-src="{{ asset('storage/' . $lineWork->image) }}">
                        @else
                            <img src="{{ asset('assets/images/website/line-works/' . $lineWork->order . '.png') }}" alt="{{ $lineWork->translations[app()->getLocale()]['title'] }}" loading="lazy"
                                class="clickable-img" data-src="{{ asset('assets/images/website/line-works/' . $lineWork->order . '.png') }}">
                        @endif
                    </div>
                </div>
            @endforeach
        @else
            <div class="step">
                ...
                <div class="image">
                    <img src="{{ asset('assets/images/website/line-works/1.png') }}" alt="{{ __('main.line_work_step1_title') }}" loading="lazy" class="clickable-img"
                        data-src="{{ asset('assets/images/website/line-works/1.png') }}">
                </div>
            </div>
            <div class="step">
                <div class="text">
                ...
                <div class="image">
                    <img src="{{ asset('assets/images/website/line-works/2.png') }}" alt="{{ __('main.line_work_step2_title') }}" loading="lazy" class="clickable-img"
                        data-src="{{ asset('assets/images/website/line-works/2.png') }}">
                </div>
            </div>
            <div class="step">
                <div class="text">
                ...
                <div class="image">
                    <img src="{{ asset('assets/images/website/line-works/3.png') }}" alt="{{ __('main.line_work_step3_title') }}" loading="lazy" class="clickable-img"
                        data-src="{{ asset('assets/images/website/line-works/3.png') }}">
                </div>
            </div>
            <div class="step">
                <div class="text">
                ...
                <div class="image">
                    <img src="{{ asset('assets/images/website/line-works/4.png') }}" alt="{{ __('main.line_work_step4_title') }}" loading="lazy" class="clickable-img"
                        data-src="{{ asset('assets/images/website/line-works/4.png') }}">
                </div>
            </div>
        @endif
    </div>
