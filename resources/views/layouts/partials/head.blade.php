...
<style>
    :root {
        ...
        --home-services-section-inline-padding: {{ $settings->sections_padding['home_services_section'] ?? 180 }}px;
        --home-projects-section-inline-padding: {{ $settings->sections_padding['home_projects_section'] ?? 20 }}px;
        --home-reviews-section-inline-padding: {{ $settings->sections_padding['home_reviews_section'] ?? 220 }}px;
        ...
        --blog-show-inline-padding: {{ $settings->sections_padding['blog_show_section'] ?? 120 }}px;
        ...
        --hosting-packages-section-inline-padding: {{ $settings->sections_padding['hosting_packages_section'] ?? 160 }}px;
        --support-hosting-section-inline-padding: {{ $settings->sections_padding['support_hosting_section'] ?? 180 }}px;
        --operations-systems-section-inline-padding: {{ $settings->sections_padding['operations_systems_section'] ?? 200 }}px;
        --your-domain-section-inline-padding: {{ $settings->sections_padding['your_domain_section'] ?? 240 }}px;
        --pest-domains-section-inline-padding: {{ $settings->sections_padding['pest_domains_section'] ?? 300 }}px;
        --official-domains-section-inline-padding: {{ $settings->sections_padding['official_domains_section'] ?? 60 }}px;
        --why-us-section-inline-padding: {{ $settings->sections_padding['why_us_section'] ?? 300 }}px;
        ...
        --dont-worry-hosting-section-inline-padding: {{ $settings->sections_padding['dont_worry_hosting_section'] ?? 120 }}px;
